...
%% ========================================================================
CRT0 = CRT_Npt(n,N1N2,N3N4);     % CRT_Npt(x,N1,N2) and N1 > N2
...
%                         STORE COEFF. IN ROM
%% ========================================================================
fileID = fopen('crt1_420.txt','w');
fprintf(fileID,'%d \t',((CRTN1pt)));
fclose(fileID);
%% ========================================================================
[Rom1_CRT] = textread('crt1_420.txt','%d');
for i = 1:1:N
    xIn(i) = x(CRTN1pt(i));
end
%% ========================================================================
...
%                         STORE COEFF. IN ROM
%% ========================================================================
fileID = fopen('crt2_420.txt','w');
fprintf(fileID,'%d \t',((CRTN2N3)));
fclose(fileID);
%% ========================================================================
[Rom2_CRT] = textread('crt2_420.txt','%d');
%% ========================================================================
for i = 1:1:N
    xInN3ptFFT(i) = xOutN1N2ptFFT(Rom2_CRT(i));
end
%% ========================================================================
xOutN1N2N3ptFFT = [];
for n3 = 1:N3:N
    xInN3ptFFTtemp = xInN3ptFFT(n3:n3+N3-1);
    xOutN3ptFFT0 = wfta_4pt(xInN3ptFFTtemp); 
...
%                         STORE COEFF. IN ROM
%% ========================================================================
fileID = fopen('rcm_420.txt','w');
fprintf(fileID,'%d \t',((RCMout)));
fclose(fileID);
%% ========================================================================
[Rom_RCM] = textread('rcm_420.txt','%d');
%% ========================================================================
XkOut = [];
for i = 1:1:N
   XkOut(i) =  xOutN1N2N3N4ptFFT(Rom_RCM(i)); 
end
%% ========================================================================
end
% figure(1);
