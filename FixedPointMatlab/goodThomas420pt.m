...
N = 420;     % input('Enter the number of points: ');
N1 = 35;     % columns
N2 = 12;     % rows
%% =================================================================
initCRT = 1:1:420;
...
xRin = sigma*randn(1,420);
xJin = sigma*randn(1,420);
...
for row = 1:1:N1
    ...
    [OutN2ptFFTR OutN2ptFFTJ] = goodThomas12ptFunction(InN2ptFFTR, InN2ptFFTJ, WL ,WF, RoundMode, Signed);
    for col = 1:1:N2
