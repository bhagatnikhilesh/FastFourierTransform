...
% clear all
% close all
function [XkR XkJ] = wfta9ptFunction(xR, xJ, WL ,WF, RoundMode, Signed)


N = 9;

% xRin = [0 1 0 0 0 0 0 0 0];   %input('Enter the real part: ');
% xJin = [0 0 0 0 0 0 0 0 0];   %input('Enter the imaginary part: ');
...
%=================================================================
        case 5
            Stage5Add2OutR = fpAdd(Stage3Add2OutR,Stage3Add0OutR);       %fR(1)
            Stage5Add2OutJ = fpAdd(Stage3Add2OutJ,Stage3Add0OutJ);       %fJ(1)
            ...
            Stage3Mul3OutR = fpMul_Elementwise(C9_1,Stage1Sub0OutJ);
            Stage3Mul3OutR = fpReformat(Stage3Mul3OutR, WL, WF, fpGetSigned(Stage3Mul3OutR), RoundMode);       %fR(5)
            Stage3Mul3OutJ = fpMul_Elementwise(C9_1Neg,Stage1Sub0OutR);
...
%             mR(8) = hR(4);                                   %mR(8)
            ...
            Stage7Add3OutRTemp = fpAdd(Stage6Sub1OutR,Stage3Mul9OutR);     %hR(5)
            Stage7Add3OutJ = fpAdd(Stage6Sub1OutJ,Stage3Mul9OutJ);     %hJ(5)
            
            Stage7Add3OutR = fpNeg(Stage7Add3OutRTemp);             %mR(4)
%             mJ(4) = hJ(5);                                    %mJ(4)
